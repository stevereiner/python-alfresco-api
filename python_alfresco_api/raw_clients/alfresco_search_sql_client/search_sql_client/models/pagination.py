...
class Pagination:
    ...
    Attributes:
        ...
        has_more_items (bool): A boolean value which is **true** if there are more entities in the collection
            beyond those in this response. A true value means a request with a larger value
            for the **skipCount** or the **maxItems** parameter will return more entities.
        max_items (int): The value of the **maxItems** parameter used to generate this list,
            or if there was no **maxItems** parameter the default value is 100
        skip_count (int): An integer describing how many entities exist in the collection before
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        has_more_items = d.pop("hasMoreItems")

        max_items = d.pop("maxItems")

        skip_count = d.pop("skipCount")
