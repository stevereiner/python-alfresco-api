...
T = TypeVar("T", bound="NodeChildAssociation")
...
class NodeChildAssociation:
    ...
    Attributes:
        ...
        association (Union[Unset, ChildAssociationInfo]):
    """
    ...
    association: Union[Unset, "ChildAssociationInfo"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_association, Unset):
            ...
            association = ChildAssociationInfo.from_dict(_association)

        node_child_association = cls(
        ...
        node_child_association.additional_properties = d
        return node_child_association
