...
T = TypeVar("T", bound="VersionEntry")
...
class VersionEntry:
    """
    Attributes:
        entry (Union[Unset, Version]):
    """

    entry: Union[Unset, "Version"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_entry, Unset):
            ...
            entry = Version.from_dict(_entry)

        version_entry = cls(
            entry=entry,
        )

        version_entry.additional_properties = d
