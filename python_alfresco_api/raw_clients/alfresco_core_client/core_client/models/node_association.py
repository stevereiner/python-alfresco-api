...
T = TypeVar("T", bound="NodeAssociation")
...
class NodeAssociation:
    ...
    Attributes:
        ...
        association (Union[Unset, AssociationInfo]):
    """
    ...
    association: Union[Unset, "AssociationInfo"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_association, Unset):
            ...
            association = AssociationInfo.from_dict(_association)

        node_association = cls(
        ...
        node_association.additional_properties = d
