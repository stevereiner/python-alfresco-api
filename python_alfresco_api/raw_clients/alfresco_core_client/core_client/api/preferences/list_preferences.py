...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/people/{person_id}/preferences",
        "params": params,
    }
...
) -> Optional[Union[Any, PreferencePaging]]:
    if response.status_code == 200:
        response_200 = PreferencePaging.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PreferencePaging]]:
    return Response(
