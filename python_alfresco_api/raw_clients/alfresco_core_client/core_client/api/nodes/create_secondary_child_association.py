...
) -> Optional[Union[Any, ChildAssociationEntry]]:
    if response.status_code == 201:
        response_201 = ChildAssociationEntry.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ChildAssociationEntry]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Create secondary child

     **Note:** this endpoint is available in Alfresco 5.2 and newer versions.

    Create a secondary child association, with the given association type, between the parent **nodeId**
    and a child node.
...
def sync(
    ...
    **Note:** You can create more than one secondary child association by
    ...
    Returns:
        Union[Any, ChildAssociationEntry]
    """
