...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/audit-applications/{audit_application_id}",
        "params": params,
    }
...
) -> Optional[Union[Any, AuditApp]]:
    if response.status_code == 200:
        response_200 = AuditApp.from_dict(response.json())
