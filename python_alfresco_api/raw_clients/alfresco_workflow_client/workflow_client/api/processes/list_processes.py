...
from ...models.process_paging import ProcessPaging
...
) -> Optional[Union[Any, ProcessPaging]]:
    if response.status_code == 200:
        response_200 = ProcessPaging.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ProcessPaging]]:
    return Response(
