"""
AlfrescoWorkflowClient - Individual client for Alfresco WORKFLOW API
...
raw_client_path = Path(__file__).parent.parent / "raw_clients" / "alfresco_workflow_client"
...
class AlfrescoWorkflowClient:
    """
    Individual client for Alfresco WORKFLOW API.
    ...
    def _init_generated_client(self) -> None:
        ...
        try:
            ...
            print(f"⚠️  Generated client not available for workflow: {e}")
            self.client = None
