...
#   timestamp: 2025-06-22T15:52:25+00:00
...
class GenericMetric(BaseModel):
    type: Annotated[str | None, Field(description='The type of metric, e.g. count')] = (
        None
    )
    value: Annotated[
        dict[str, Any] | None,
        Field(description='The metric value, e.g. {"count": 34}\n'),
    ] = None


class Pagination(BaseModel):
    count: Annotated[
        int, Field(description='The number of objects in the entries array.\n')
    ]
...
class RequestDefaults(BaseModel):
    ...
    namespace: Annotated[
        str | None,
        Field(description='The default name space to use if one is not provided'),
    ] = 'cm'
...
class RequestFacetQueries(RootModel[list[RequestFacetQuery]]):
    root: Annotated[
        list[RequestFacetQuery], Field(description='Facet queries to include')
    ]
...
class RequestFacetSet(BaseModel):
    ...
    label: Annotated[
        str | None, Field(description='A label to use to identify the set')
    ] = None
...
class FieldModel(BaseModel):
    field: Annotated[
        str | None, Field(description='The name of the field to highlight.')
    ] = None
...
class RequestLimits(BaseModel):
    permissionEvaluationCount: Annotated[
        int | None,
        Field(description='Maximum count of post query permission evaluations'),
    ] = 2000
    permissionEvaluationTime: Annotated[
        int | None,
        Field(description='Maximum time for post query permission evaluation'),
    ] = 20000
...
class RequestLocalization(BaseModel):
    ...
    timezone: Annotated[
        str | None,
        Field(description='A valid timezone id supported by @see java.time.ZoneId'),
    ] = None
...
class RequestQuery(BaseModel):
    language: Annotated[
        Language | None,
        Field(description='The query language in which the query is written.'),
    ] = 'afts'
    query: Annotated[
        str,
        Field(
...
class RequestRange(BaseModel):
    ...
    excludeFilters: Annotated[
        list[str] | None,
        Field(description='Filter queries to exclude when calculating statistics'),
    ] = None
    field: Annotated[
        str | None, Field(description='The name of the field to perform range')
    ] = None
    ...
    include: Annotated[
        list[str] | None, Field(description='lower, upper, edge, outer, all')
    ] = None
    label: Annotated[
        str | None, Field(description='A label to include as a pivot reference')
    ] = None
    other: Annotated[
        list[str] | None, Field(description='before, after, between, non, all')
    ] = None
    start: Annotated[str | None, Field(description='The start of the range')] = None
...
class RequestStats(BaseModel):
    ...
    label: Annotated[
        str | None,
        Field(description='A label to include for reference the stats field'),
    ] = None
    max: Annotated[bool | None, Field(description='The maximum value of the field')] = (
        True
    )
    mean: Annotated[bool | None, Field(description='The average')] = True
    min: Annotated[bool | None, Field(description='The minimum value of the field')] = (
        True
    )
    missing: Annotated[
        bool | None,
        Field(description='The number which do not have a value for this field'),
    ] = True
    percentiles: Annotated[
        list[float] | None,
        Field(description='A list of percentile values, e.g. "1,99,99.9"'),
    ] = None
    stddev: Annotated[bool | None, Field(description='Standard deviation')] = True
    sum: Annotated[
        bool | None, Field(description='The sum of all values of the field')
    ] = True
    sumOfSquares: Annotated[
        bool | None, Field(description='Sum of all values squared')
    ] = True
...
class ResponseConsistency(BaseModel):
    lastTxId: Annotated[
        int | None, Field(description='The id of the last indexed transaction')
    ] = None
...
class Bucket(BaseModel):
    ...
    filterQuery: Annotated[
        str | None,
        Field(description='The filter query you can use to apply this facet'),
    ] = None
...
class ResultBuckets(BaseModel):
    buckets: Annotated[
        list[Bucket] | None, Field(description='An array of buckets and values')
    ] = None
    label: Annotated[
        str | None,
        Field(
...
class SpellcheckItem(BaseModel):
    suggestion: Annotated[
        list[str] | None, Field(description='A suggested alternative query')
    ] = None
...
class GenericBucket(BaseModel):
    ...
    facets: Annotated[
        ...
        Field(description='Additional list of nested facets'),
    ] = None
    filterQuery: Annotated[
        str | None,
        Field(description='The filter query you can use to apply this facet'),
...
class GenericFacetResponse(BaseModel):
    ...
    type: Annotated[
        str | None,
        Field(description='The facet type, eg. interval, range, pivot, stats'),
    ] = None
...
class Interval(BaseModel):
    ...
    sets: Annotated[
        list[RequestFacetSet] | None,
        Field(description='Sets the intervals for all fields.'),
    ] = None
...
class RequestFacetIntervals(BaseModel):
    intervals: Annotated[
        list[Interval] | None,
        Field(description='Specifies the fields to facet by interval.'),
    ] = None
    sets: Annotated[
        list[RequestFacetSet] | None,
        Field(description='Sets the intervals for all fields.'),
...
class SearchRequest(BaseModel):
    ...
    includeRequest: Annotated[
        bool | None,
        Field(description='When true, include the original request in the response'),
    ] = False
