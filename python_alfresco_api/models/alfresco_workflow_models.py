...
#   timestamp: 2025-06-22T15:52:26+00:00
...
class Process(BaseModel):
    ...
    durationInMs: Annotated[
        int | None, Field(description='The duration of this process')
    ] = None
    ...
    processDefinitionId: Annotated[
        str | None,
        Field(description='The unique identity of the owning process definition'),
    ] = None
...
class ProcessDefinition(BaseModel):
    category: Annotated[
        str | None,
        Field(description='The category to which this process definition belongs'),
    ] = None
    deploymentId: Annotated[
        str | None,
        Field(description='The deployment of which this process definition is a part'),
    ] = None
    ...
    key: Annotated[
        str | None, Field(description='The key of this process definition')
    ] = None
    name: Annotated[
        str | None, Field(description='The name of this process definition')
    ] = None
    startFormResourceKey: Annotated[
        str | None, Field(description='The start form key')
    ] = None
    title: Annotated[
        str | None, Field(description='The title of this process definition')
    ] = None
...
class Task(BaseModel):
    ...
    assignee: Annotated[
        str | None,
        Field(description='The id of the user who is currently assigned this task'),
    ] = None
    description: Annotated[
        str | None, Field(description='The description of this task')
    ] = None
    dueAt: Annotated[
        datetime | None, Field(description='The date time this task is due')
    ] = None
    durationInMs: Annotated[
        int | None, Field(description='The duration of this task')
    ] = None
    endedAt: Annotated[
        datetime | None, Field(description='The date time this task started')
    ] = None
    ...
    owner: Annotated[
        str | None, Field(description='The id of the user who owns this task')
    ] = None
    priority: Annotated[
        int | None, Field(description='The numeric priority of this task')
    ] = None
    processDefinitionId: Annotated[
        str | None,
        Field(description='The unique identity of the owning process definition'),
    ...
    processId: Annotated[
        str | None, Field(description="The containing process's unique id")
    ] = None
    startedAt: Annotated[
        datetime | None, Field(description='The date time this task started')
    ] = None
