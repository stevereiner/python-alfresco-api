...
#   timestamp: 2025-06-20T04:01:10+00:00
...
class RequestPagination(BaseModel):
    ...
    maxItems: Optional[conint(ge=1)] = Field(
        100, description="The maximum number of items to return in the query results"
    )
    skipCount: Optional[conint(ge=0)] = Field(
        0, description="The number of items to skip from the start of the query set"
    )
