...
client_dir = Path(__file__).parent.parent / "enhanced_generated" / "clients" / "alfresco-search"
...
class EnhancedAlfrescosearchClient:
    ...
    def _import_apis(self):
        ...
        try:
            ...
            from alfresco_search_client.api import DefaultApi
...
def create_client(host: str = "http://localhost:8080", username: str = "admin", password: str = "admin") -> EnhancedAlfrescosearchClient:
    """Convenience function to create an enhanced client"""
    return EnhancedAlfrescosearchClient(host, username, password)
