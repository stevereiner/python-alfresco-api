...
client_dir = Path(__file__).parent.parent / "enhanced_generated" / "clients" / "alfresco-search-sql"
...
class EnhancedAlfrescosearchsqlClient:
    ...
    def _import_apis(self):
        ...
        try:
            ...
            from alfresco_search_sql_client.api import DefaultApi
...
def create_client(host: str = "http://localhost:8080", username: str = "admin", password: str = "admin") -> EnhancedAlfrescosearchsqlClient:
    """Convenience function to create an enhanced client"""
    return EnhancedAlfrescosearchsqlClient(host, username, password)
