...
client_dir = Path(__file__).parent.parent / "enhanced_generated" / "clients" / "alfresco-core"
...
class EnhancedAlfrescocoreClient:
    ...
    def _import_apis(self):
        ...
        try:
            ...
            from alfresco_core_client.api import DefaultApi
...
def create_client(host: str = "http://localhost:8080", username: str = "admin", password: str = "admin") -> EnhancedAlfrescocoreClient:
    """Convenience function to create an enhanced client"""
    return EnhancedAlfrescocoreClient(host, username, password)
