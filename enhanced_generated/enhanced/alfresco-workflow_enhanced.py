"""
Enhanced Alfresco-Workflow API Client
...
class EnhancedAlfrescoworkflowClient:
    ...
    def _import_apis(self):
        ...
        try:
            ...
            from alfresco_workflow_client.api import DefaultApi
...
def create_client(host: str = "http://localhost:8080", username: str = "admin", password: str = "admin") -> EnhancedAlfrescoworkflowClient:
    """Convenience function to create an enhanced client"""
    return EnhancedAlfrescoworkflowClient(host, username, password)
