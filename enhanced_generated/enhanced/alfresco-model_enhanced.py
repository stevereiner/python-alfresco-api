"""
Enhanced Alfresco-Model API Client
...
api_name = "Alfresco-Model"

# Add generated client to path
client_dir = Path(__file__).parent.parent / "enhanced_generated" / "clients" / "alfresco-model"
...
class EnhancedAlfrescomodelClient:
    ...
    def _import_apis(self):
        ...
        try:
            ...
            from alfresco_model_client.api import DefaultApi
...
def create_client(host: str = "http://localhost:8080", username: str = "admin", password: str = "admin") -> EnhancedAlfrescomodelClient:
    """Convenience function to create an enhanced client"""
    return EnhancedAlfrescomodelClient(host, username, password)
