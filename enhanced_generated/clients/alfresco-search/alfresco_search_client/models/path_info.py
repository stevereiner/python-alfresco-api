...
class PathInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["elements", "isComplete", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [PathElement.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None,
