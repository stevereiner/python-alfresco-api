...
class ResultSetPagingList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["context", "entries", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [ResultSetRowEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
