...
class Node(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allowableOperations", "aspectNames", "content", "createdAt", "createdByUser", "id", "isFile", "isFolder", "isLink", "isLocked", "modifiedAt", "modifiedByUser", "name", "nodeType", "parentId", "path", "properties"]
