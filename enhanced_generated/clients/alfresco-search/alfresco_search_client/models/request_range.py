...
class RequestRange(BaseModel):
    ...
    var_field: Optional[StrictStr] = Field(default=None, description="The name of the field to perform range", alias="field")
    ...
    __properties: ClassVar[List[str]] = ["end", "excludeFilters", "field", "gap", "hardend", "include", "label", "other", "start"]
