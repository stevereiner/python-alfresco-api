...
class ResultNode(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allowableOperations", "aspectNames", "content", "createdAt", "createdByUser", "id", "isFile", "isFolder", "isLink", "isLocked", "modifiedAt", "modifiedByUser", "name", "nodeType", "parentId", "path", "properties", "archivedAt", "archivedByUser", "search", "versionComment", "versionLabel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "archivedByUser": UserInfo.from_dict(obj["archivedByUser"]) if obj.get("archivedByUser") is not None else None,
            "search": SearchEntry.from_dict(obj["search"]) if obj.get("search") is not None else None,
