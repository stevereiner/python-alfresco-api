...
class ResultBuckets(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["buckets", "label"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buckets": [ResultBucketsBucketsInner.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None,
            "label": obj.get("label")
        })
        return _obj
