...
class Version(object):
    ...
    def __init__(self, aspect_names=None, content=None, id=None, is_file=None, is_folder=None, modified_at=None, modified_by_user=None, name=None, node_type=None, properties=None, version_comment=None):  # noqa: E501
