...
class NodeBodyCreate(object):
    ...
    def __init__(self, aspect_names=None, association=None, definition=None, name=None, node_type=None, permissions=None, properties=None, relative_path=None, secondary_children=None, targets=None):  # noqa: E501
