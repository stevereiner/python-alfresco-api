...
class SharedLink(object):
    ...
    def __init__(self, allowable_operations=None, allowable_operations_on_target=None, aspect_names=None, content=None, description=None, expires_at=None, id=None, is_favorite=None, modified_at=None, modified_by_user=None, name=None, node_id=None, path=None, properties=None, shared_by_user=None, title=None):  # noqa: E501
