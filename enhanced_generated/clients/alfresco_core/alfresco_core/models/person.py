...
class Person(object):
    ...
    def __init__(self, aspect_names=None, avatar_id=None, capabilities=None, company=None, description=None, display_name=None, email=None, email_notifications_enabled=True, enabled=True, first_name=None, google_id=None, id=None, instant_message_id=None, job_title=None, last_name=None, location=None, mobile=None, properties=None, skype_id=None, status_updated_at=None, telephone=None, user_status=None):  # noqa: E501
