...
class ModelProperty(object):
    ...
    def __init__(self, constraints=None, data_type=None, default_value=None, description=None, id=None, is_mandatory=None, is_mandatory_enforced=None, is_multi_valued=None, is_protected=None, title=None):  # noqa: E501
