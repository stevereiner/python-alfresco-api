...
class Comment(object):
    ...
    def __init__(self, can_delete=None, can_edit=None, content=None, created_at=None, created_by=None, edited=None, id=None, modified_at=None, modified_by=None, title=None):  # noqa: E501
