...
class Node(object):
    ...
    def __init__(self, allowable_operations=None, aspect_names=None, content=None, created_at=None, created_by_user=None, definition=None, id=None, is_favorite=None, is_file=None, is_folder=None, is_link=None, is_locked=False, modified_at=None, modified_by_user=None, name=None, node_type=None, parent_id=None, path=None, permissions=None, properties=None):  # noqa: E501
