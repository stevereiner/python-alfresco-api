...
from alfresco_auth_client.api_client import ApiClient, RequestSerialized
from alfresco_auth_client.api_response import ApiResponse
from alfresco_auth_client.rest import RESTResponseType
...
class AuthenticationApi:
    ...
    def validate_ticket(
        ...
        **Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Validates the specified ticket (derived from Authorization header) is still valid.  For example, you can pass the Authorization request header using Javascript:   ```Javascript     request.setRequestHeader (\"Authorization\", \"Basic \" + btoa(ticket));   ``` 
        ...
        _param = self._validate_ticket_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def validate_ticket_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def validate_ticket_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _validate_ticket_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
