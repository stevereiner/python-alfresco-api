...
class PersonBodyCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aspectNames", "company", "description", "email", "emailNotificationsEnabled", "enabled", "firstName", "googleId", "id", "instantMessageId", "jobTitle", "lastName", "location", "mobile", "password", "properties", "skypeId", "telephone", "userStatus"]
