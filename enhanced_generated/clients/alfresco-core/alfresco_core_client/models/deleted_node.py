...
class DeletedNode(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allowableOperations", "aspectNames", "content", "createdAt", "createdByUser", "definition", "id", "isFavorite", "isFile", "isFolder", "isLink", "isLocked", "modifiedAt", "modifiedByUser", "name", "nodeType", "parentId", "path", "permissions", "properties", "archivedAt", "archivedByUser"]
