...
class NodeChildAssociationPagingList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["entries", "pagination", "source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [NodeChildAssociationEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "pagination": Pagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "source": Node.from_dict(obj["source"]) if obj.get("source") is not None else None
        })
        return _obj
