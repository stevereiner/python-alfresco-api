...
class NodeChildAssociation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allowableOperations", "aspectNames", "content", "createdAt", "createdByUser", "definition", "id", "isFavorite", "isFile", "isFolder", "isLink", "isLocked", "modifiedAt", "modifiedByUser", "name", "nodeType", "parentId", "path", "permissions", "properties", "association"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "association": ChildAssociationInfo.from_dict(obj["association"]) if obj.get("association") is not None else None
        })
        return _obj
