...
class DirectAccessUrlBodyCreate(BaseModel):
    ...
    valid_for: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="The length of time in seconds that the url is valid for. ", alias="validFor")
    __properties: ClassVar[List[str]] = ["expiresAt", "validFor"]
