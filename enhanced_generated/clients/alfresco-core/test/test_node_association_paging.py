    ...
    def make_instance(self, include_optional) -> NodeAssociationPaging:
        ...
        if include_optional:
            return NodeAssociationPaging(
                list = alfresco_core_client.models.node_association_paging_list.NodeAssociationPaging_list(
                    entries = [
                        alfresco_core_client.models.node_association_entry.NodeAssociationEntry(
                            entry = null, )
                        ], 
