    ...
    def make_instance(self, include_optional) -> ActivityPaging:
        ...
        if include_optional:
            return ActivityPaging(
                list = alfresco_core_client.models.activity_paging_list.ActivityPaging_list(
                    entries = [
                        alfresco_core_client.models.activity_entry.ActivityEntry(
                            entry = alfresco_core_client.models.activity.Activity(
                                activity_summary = {
                                    'key' : ''
                                    }, 
                                activity_type = '', 
