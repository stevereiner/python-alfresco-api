    ...
    def make_instance(self, include_optional) -> NodeChildAssociationPaging:
        ...
        if include_optional:
            return NodeChildAssociationPaging(
                list = alfresco_core_client.models.node_child_association_paging_list.NodeChildAssociationPaging_list(
                    entries = [
                        alfresco_core_client.models.node_child_association_entry.NodeChildAssociationEntry(
                            entry = null, )
                        ], 
