    ...
    def make_instance(self, include_optional) -> CommentPaging:
        ...
        if include_optional:
            return CommentPaging(
                list = alfresco_core_client.models.comment_paging_list.CommentPaging_list(
                    entries = [
                        alfresco_core_client.models.comment_entry.CommentEntry(
                            entry = alfresco_core_client.models.comment.Comment(
                                can_delete = True, 
                                can_edit = True, 
                                content = '', 
