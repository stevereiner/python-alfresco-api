...
class TestPersonPaging(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PersonPaging:
        ...
        if include_optional:
            return PersonPaging(
                list = alfresco_core_client.models.person_paging_list.PersonPaging_list(
                    entries = [
                        alfresco_core_client.models.person_entry.PersonEntry(
                            entry = alfresco_core_client.models.person.Person(
                                aspect_names = [
                                    ''
                                    ], 
                                avatar_id = '', 
