...
class AbstractClassAssociationSource(BaseModel):
    ...
    is_mandatory_enforced: Optional[StrictBool] = Field(default=None, alias="isMandatoryEnforced")
    is_many: Optional[StrictBool] = Field(default=None, alias="isMany")
    role: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cls", "isMandatory", "isMandatoryEnforced", "isMany", "role"]
