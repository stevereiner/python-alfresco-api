...
class Model(BaseModel):
    ...
    id: StrictStr
    namespace_prefix: Optional[StrictStr] = Field(default=None, alias="namespacePrefix")
    namespace_uri: Optional[StrictStr] = Field(default=None, alias="namespaceUri")
    __properties: ClassVar[List[str]] = ["author", "description", "id", "namespacePrefix", "namespaceUri"]
