...
class AbstractClassAssociation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "id", "isChild", "isProtected", "source", "target", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": AbstractClassAssociationSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "target": AbstractClassAssociationSource.from_dict(obj["target"]) if obj.get("target") is not None else None,
            "title": obj.get("title")
        })
        return _obj
