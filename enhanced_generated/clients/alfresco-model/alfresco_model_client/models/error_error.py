...
class ErrorError(BaseModel):
    ...
    description_url: Optional[StrictStr] = Field(default=None, alias="descriptionURL")
    ...
    __properties: ClassVar[List[str]] = ["briefSummary", "descriptionURL", "errorKey", "logId", "stackTrace", "statusCode"]
