...
class TestAspectPaging(unittest.TestCase):
    """AspectPaging unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AspectPaging:
        """Test AspectPaging
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AspectPaging`
        """
        model = AspectPaging()
        if include_optional:
            return AspectPaging(
                list = alfresco_model_client.models.aspect_paging_list.AspectPaging_list(
                    entries = [
