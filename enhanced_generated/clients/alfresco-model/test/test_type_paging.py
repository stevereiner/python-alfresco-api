...
class TestTypePaging(unittest.TestCase):
    """TypePaging unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypePaging:
        """Test TypePaging
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypePaging`
        """
        model = TypePaging()
        if include_optional:
            return TypePaging(
                list = alfresco_model_client.models.type_paging_list.TypePaging_list(
                    entries = [
                        alfresco_model_client.models.type_entry.TypeEntry(
