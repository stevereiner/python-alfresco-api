...
class TestTypePagingList(unittest.TestCase):
    """TypePagingList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypePagingList:
        """Test TypePagingList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypePagingList`
        """
        model = TypePagingList()
        if include_optional:
