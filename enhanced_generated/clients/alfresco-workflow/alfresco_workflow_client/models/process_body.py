...
class ProcessBody(BaseModel):
    ...
    """ # noqa: E501
    process_definition_key: Optional[StrictStr] = Field(default=None, alias="processDefinitionKey")
    variables: Optional[ProcessBodyVariable] = None
    __properties: ClassVar[List[str]] = ["processDefinitionKey", "variables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "processDefinitionKey": obj.get("processDefinitionKey"),
            "variables": ProcessBodyVariable.from_dict(obj["variables"]) if obj.get("variables") is not None else None
        })
        return _obj
