...
class Pagination(BaseModel):
    ...
    max_items: Optional[StrictInt] = Field(default=None, description="The value of the **maxItems** parameter used to generate this list, or if there was no **maxItems** parameter the default value, 10 ", alias="maxItems")
    skip_count: Optional[StrictInt] = Field(default=None, description="An integer describing how many entities exist in the collection before those included in this list. ", alias="skipCount")
