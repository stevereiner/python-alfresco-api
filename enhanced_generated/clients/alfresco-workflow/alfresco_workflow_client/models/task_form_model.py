...
class TaskFormModel(BaseModel):
    ...
    """ # noqa: E501
    allowed_values: Optional[List[StrictStr]] = Field(default=None, description="An array of allowed values for this item", alias="allowedValues")
    ...
    __properties: ClassVar[List[str]] = ["allowedValues", "dataType", "defaultValue", "name", "qualifiedName", "required", "title"]
