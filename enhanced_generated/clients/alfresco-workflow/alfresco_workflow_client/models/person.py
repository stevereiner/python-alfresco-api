...
class Person(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["avatarId", "company", "description", "email", "emailNotificationsEnabled", "enabled", "firstName", "googleId", "id", "instantMessageId", "jobTitle", "lastName", "location", "mobile", "skypeId", "statusUpdatedAt", "telephone", "userStatus"]
